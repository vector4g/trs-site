...
const LAYERS = [
  {
    ...
    sub: "7-Layer Retrieval-Augmented Grounding",
    annotation: "Special-category input · transient",
    components: [
      "App (Zero-Knowledge)",
      "Sovereign DB (Static Sources)",
      "Federated Router (Live Telemetry)",
    ],
  },
  {
    num: "L2",
    title: "The DReaMAD Protocol",
    sub: "Stateless Analysis Enclave",
    annotation:
      "24-call multi-agent debate · transient memory · heterogeneous routing",
    components: [
      "TRS-01: Grandin — Sensory / Neuro-Safety",
      "TRS-02: Heumann — Physical Accessibility",
      "TRS-03: Crenshaw — Intersectional Identity",
      "Parallel: Fact Checker · Pro/Con Advocate · Bias Checker · Lived Exp · Policy Analyst · Synthesizer",
    ],
  },
  {
    num: "L3",
    title: "Output Synthesis & Regulatory Alignment",
    sub: "Sanitized dossier · audit trail",
    annotation: "Zero retention — special-category inputs purged",
    components: [
      "Enterprise & Traveler Outputs",
